#include <Servo.h>
/* blek2byte PWM motor contrul using two 8-bit byte commands = 2 x 8 - 1 sync bit per character = 14 available bits
 ; 7 lsb of first message character are a command
 ; second character is 7-bit data
 ; compatible with e.g. this SimHub plugin:
 ; https://github.com/blekenbleu/Fake8
 */
